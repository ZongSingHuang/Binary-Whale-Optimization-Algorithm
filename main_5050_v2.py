...
for i in range(times):
    ...
    optimizer = BWOA(fit_func=loss1, 
                     num_dim=X_train1.shape[1], num_particle=p, max_iter=g, x_max=1, x_min=0)
    optimizer.opt()
    ...
    optimizer = BWOA(fit_func=loss2, 
                     num_dim=X_train2.shape[1], num_particle=p, max_iter=g, x_max=1, x_min=0)
    optimizer.opt()
    ...
    optimizer = BWOA(fit_func=loss3, 
                     num_dim=X_train3.shape[1], num_particle=p, max_iter=g, x_max=1, x_min=0)
    optimizer.opt()
    ...
    optimizer = BWOA(fit_func=loss4, 
                     num_dim=X_train4.shape[1], num_particle=p, max_iter=g, x_max=1, x_min=0)
    optimizer.opt()
    ...
    optimizer = BWOA(fit_func=loss5, 
                     num_dim=X_train5.shape[1], num_particle=p, max_iter=g, x_max=1, x_min=0)
    optimizer.opt()
    ...
    optimizer = BWOA(fit_func=loss6, 
                     num_dim=X_train6.shape[1], num_particle=p, max_iter=g, x_max=1, x_min=0)
    optimizer.opt()
    ...
    optimizer = BWOA(fit_func=loss7, 
                     num_dim=X_train7.shape[1], num_particle=p, max_iter=g, x_max=1, x_min=0)
    optimizer.opt()
    ...
    optimizer = BWOA(fit_func=loss8, 
                     num_dim=X_train8.shape[1], num_particle=p, max_iter=g, x_max=1, x_min=0)
    optimizer.opt()
    ...
    optimizer = BWOA(fit_func=loss9, 
                     num_dim=X_train9.shape[1], num_particle=p, max_iter=g, x_max=1, x_min=0)
    optimizer.opt()
    ...
    optimizer = BWOA(fit_func=loss10, 
                     num_dim=X_train10.shape[1], num_particle=p, max_iter=g, x_max=1, x_min=0)
    optimizer.opt()
    ...
    optimizer = BWOA(fit_func=loss11, 
                     num_dim=X_train11.shape[1], num_particle=p, max_iter=g, x_max=1, x_min=0)
    optimizer.opt()
    ...
    optimizer = BWOA(fit_func=loss12, 
                     num_dim=X_train12.shape[1], num_particle=p, max_iter=g, x_max=1, x_min=0)
    optimizer.opt()
    ...
    optimizer = BWOA(fit_func=loss13, 
                     num_dim=X_train13.shape[1], num_particle=p, max_iter=g, x_max=1, x_min=0)
    optimizer.opt()
    ...
    optimizer = BWOA(fit_func=loss14, 
                     num_dim=X_train14.shape[1], num_particle=p, max_iter=g, x_max=1, x_min=0)
    optimizer.opt()
    ...
    optimizer = BWOA(fit_func=loss15, 
                     num_dim=X_train15.shape[1], num_particle=p, max_iter=g, x_max=1, x_min=0)
    optimizer.opt()
    ...
    optimizer = BWOA(fit_func=loss16, 
                     num_dim=X_train16.shape[1], num_particle=p, max_iter=g, x_max=1, x_min=0)
    optimizer.opt()
    ...
    optimizer = BWOA(fit_func=loss17, 
                     num_dim=X_train17.shape[1], num_particle=p, max_iter=g, x_max=1, x_min=0)
    optimizer.opt()
    ...
    optimizer = BWOA(fit_func=loss18, 
                     num_dim=X_train18.shape[1], num_particle=p, max_iter=g, x_max=1, x_min=0)
    optimizer.opt()
